*Hallo nama saya Aditya khaedirrohman. Disini saya akan menjelaskan cara penggunaan Git yang kita perlukan aialah*  Applikasi git , akun git. Sebelum itu saya akan kasih tutorial cara penginstalan *GIT*.
